...
const Header = () => {
  return (
    <header className="container mx-auto bg-gray-300 h-[70px] flex justify-between items-center p-3 gap-2">
      <Link to="/"><h1 className="text-lg md:text-3xl ">Real Estate</h1></Link>
      ...
      <ul className="flex items-center gap-5 text-2xl">
        ...
        <Link to="/login"> <li className="text-lg md:text-2xl rounded-full bg-blue-900 px-3 md:px-4 py-1 text-white">
          Log In
        </li></Link>
      </ul>
    </header>
